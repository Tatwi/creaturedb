...
<div class="contentbox">
	...
	$sql = "SELECT Creature_Name, Planet, Level, Taming_Chance, Attack_1, Attack_2 FROM Tarkin_Creatures WHERE Attack_1 LIKE '". $_POST["attack"]. "' OR Attack_2 LIKE '". $_POST["attack"]. "' ORDER By Planet, length(Level) ASC, Level ASC";
