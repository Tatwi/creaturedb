<div class="question">
	<form action="a10.php" method="post">
		What can I sample DNA from that has 
		<select name="attack">
			<option value="creatureareacombo">Area Combo</option>
			...
			<option value="creatureareaknockdown">Force Strike</option>
		 ...
		 as a primary or secondary attack? 
