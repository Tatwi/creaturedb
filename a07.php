...
<div class="contentbox">
	...
	for ($x = 0; $x < $answersize; $x++) {
		...
		echo "<tr><td><a href='#' onclick='loadCreaturePage(\"". $answer[$x]["Creature_Name"] . "\")'>". makePretty($answer[$x]["Creature_Name"]). "</a></td><td>". $answer[$x]["Planet"]. "</td><td>". $answer[$x]["Level"]. "</td><td>". $aggressive. "</td><td>". $answer[$x]["Mount"]. "</td></tr>";
	}
	echo "</table><br />";
